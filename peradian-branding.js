  ...
  function fixArchiveVisuals(){
    if(!document.getElementById('peradian-visual-fixes')){
      const style=document.createElement('style');style.id='peradian-visual-fixes';style.textContent=`
        ...
        .founder{display:grid!important;grid-template-columns:190px minmax(0,1fr)!important;grid-auto-flow:row!important;gap:20px 26px!important;align-items:start!important;margin:0 0 40px!important;padding:20px!important}
        .founder>div:not(.founder-photo){display:contents!important}
        .founder-photo{grid-column:1!important;grid-row:1!important;width:190px!important;height:238px!important;min-width:190px!important;min-height:238px!important;aspect-ratio:4/5!important;object-fit:cover!important;object-position:center 8%!important;padding:0!important;background:#070707!important;border-radius:22px!important;align-self:start!important}
        .founder-kicker{grid-column:2!important;grid-row:1!important;align-self:start!important;margin-top:4px!important}
        .founder h3{grid-column:2!important;grid-row:1!important;align-self:start!important;margin-top:25px!important}
        .founder-role{grid-column:2!important;grid-row:1!important;align-self:start!important;margin-top:72px!important}
        ...
        @media(max-width:700px){
          .founder{grid-template-columns:145px minmax(0,1fr)!important;gap:16px 16px!important;padding:16px!important}
          ...
          .founder h3{font-size:25px!important;line-height:1.05!important;margin-top:24px!important}
          .founder-role{font-size:10px!important;margin-top:66px!important;line-height:1.4!important}
